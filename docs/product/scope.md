...
- Implemented on main as unreleased v0.4 work: `interactive-rebase-basic`, `tag-release-fix`, and `merge-vs-rebase`.
- Remaining advanced exercise candidate: `bisect-basic`.
